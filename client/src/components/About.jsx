    ...
    <div className={style.container}>
      ...
      <div className={style.about}>
        ...
        <h3 className={style.text}>
          My name is Francisco and I'm studying Full Stack developer! I made my
          website as an individual project for the Soy Henry bootcamp! <br />
        </h3>
        <h3 className={style.text}>Contact!</h3>
